...
public class TestClientFileSendThread extends TestCase {
	...
	public void testThreadFileDeletionDuringRead() throws Exception {
		...
		try {
			InetSocketAddress address = new InetSocketAddress(testPort);
			...
			ThreadContext context = new ThreadContext(memory, queue, chunkSend,
					address, agentStatus, 1000L, 1);
	 ...
	 * restart reading from this file pointer posisiton.<br/>
	 * 
	 * @throws Exception
	 */
	@Test
