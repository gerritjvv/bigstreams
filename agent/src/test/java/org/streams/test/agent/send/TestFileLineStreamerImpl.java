...
/**
 * 
 * For this test to work the java.library.path must point to the lzo native libraries.
 *
 */
public class TestFileLineStreamerImpl extends TestCase {
	...
	public void testStreamingFile() throws Throwable {
		...
		try {
			...
			System.out.println("String bytes: " + buff.toString().getBytes().length);
	...
	public void setUp() throws Exception {
		...
		if(arch.contains("i386")){
			libPath = new File(".", "src/main/resources/native/Linux-i386-32").getAbsolutePath();
		}else{
			libPath = new File(".", "src/main/resources/native/Linux-amd64-64").getAbsolutePath();
		}
