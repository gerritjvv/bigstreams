...
/**
 * Tests the service by Locking and un locking the same file N times.
 * 
 */
public class TestSingleFileLock {
	...
	public static void main(String[] args) throws Exception {
		...
		int unlockport = conf.getInt(
				CoordinationProperties.PROP.COORDINATION_UNLOCK_PORT.toString(),
		...
		try {
			...
			System.out
					.println("----------------- Test Single File Lock Results ---------------------- ");

			System.out.println("Tests run: " + count + " of " + testCount);
			System.out.println("MaxTime: " + maxTime);
			System.out.println("MinTime: " + minTime);
			System.out.println("AvgTime: " + (total / count));
			System.out
					.println("----------------- ----------------------------- ---------------------- ");
			System.out.flush();
		}
	 ...
	 * @param url
	 */
	private static void testLockRelease(CoordinationServiceClient client) {

		FileTrackingStatus fileStatus = new FileTrackingStatus(0L, 10L, 0,
				"test1_agent", "file", "type");
